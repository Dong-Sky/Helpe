...
function isRealNum(val){
   ...
   class publish_Ask extends Component {
  constructor(props) {
       super(props);
       this.state = {
         token: null,
  ...
  //定义默认图片
  returnDefaultPic = () => {
    if(this.state.defaultImgSouce==null||this.state.defaultImgSouce==''){
      return(
