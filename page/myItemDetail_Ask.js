         ...
         <ScrollView>
           <List containerStyle={[styles.list,{marginTop: 0}]}>
             <ListItem
               component={TouchableOpacity}
               titleStyle={styles.title}
               title={I18n.t('itemDetail.A_name')}
               containerStyle={styles.listContainerStyle}
               rightIcon={
                 <TextInput
                     ...
                     titleStyle={styles.title}
                     placeholder={I18n.t('itemDetail.txt1')}
           ...
           <List containerStyle={styles.list}>
             ...
             <ListItem
               titleStyle={styles.title}
               rightTitle={I18n.t('itemDetail.t30')}
               containerStyle={styles.listContainerStyle}
               title={I18n.t('itemDetail.deadline1')}
             />
           </List>
           {this.showLoading()}
         </ScrollView>
        ...
        <ScrollView>
          ...
          <TouchableOpacity style={styles.item}>
            ...
            <Text style={[styles.title,styles.sub]}>
              {I18n.t('itemDetail.A_cate')+': '+this.state.category.name}
            </Text>
            <Text style={[styles.title,styles.sub]}>
